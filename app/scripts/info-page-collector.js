...
export default class InfoPageCollector {
    constructor() {
        ...
        this.course_cover = document.querySelector('.lessons-item [itemprop="thumbnail"]').href;
        this.course_name = document.querySelector('h1.hero-title').textContent;
        this.course_info_script = document.querySelector('[type="application/ld+json"]').textContent;
    ...
    async build() {
        ...
        <body>
            ...
            ${await (async () => {
                let header = document.querySelector('.hero.hero-gradient').cloneNode(true);
                ...
                breadcrumbs_active.innerHTML = /* html */ `
                    <a class="breadcrumbs__a" itemprop="item" href="${document.location.href}">
            ...
            <div class="container">
                ${await (async () => {
                    ...
                    let course_main_info = document.querySelector('div.course-wrap').cloneNode(true);
                    ...
                    let course_description_header = document.createElement('h2');
                    ...
                    let lessons_list = document.querySelector('#lessons-list').cloneNode(true);
                    ...
                    let materials = document.querySelector('section.section-block.mb-20');                    
                    if(materials) {
